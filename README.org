...
* THX version
  *****************************************************************
  Note: NOT WORKING -> pip cannot install dependencies on debian 12
  *****************************************************************
  ...
  This [[https://github.com/fructu/python-slip39.thx][python-slip39.thx]] project, it is just to run
  a portion of it inside of linux debian.

  I just want to have some backup process for [[https://github.com/trezor/python-shamir-mnemonic/][python-shamir-mnemonic]]
  or iancoleman tools.

  So far I am focus on these
  	bash slip39_generate.sh
	bash slip39_recover.sh


** install
  sudo apt-get install build-essential libssl-dev

		pip install eth-account           #<<< only first time
		pip install pyserial               #<<< only first time

   #+LATEX: {\scriptsize
   #+BEGIN_SRC bash :exports both :results output drawer
   python3 -m venv venv
   source venv/bin/activate
   pip install -r requirements_thx.txt
   deactivate
   #+END_SRC
